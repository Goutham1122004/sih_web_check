      ...
      <FilterButtons>{ showFilters ? <>
        ...
        <span className="toggle-filters" onClick={() => setShowFilters(false)}>Hide</span>
          ...
          <div className="control-options">
            ...
            {/* <a href="#"><span className="toggle-filters">Export Data</span></a>
            <a href="#"><span className="toggle-filters">Learn about the Results</span></a> */}
            <a target="_blank" rel="noreferrer" href={`http://127.0.0.1:5000/scan/${address.slice(8)}`}><span className="toggle-filters">Perform Advanced Analysis</span></a> 
            <a target="_blank" rel="noreferrer" href="http://127.0.0.1:5000">
  <span className="toggle-filters">Multilingual AI Chatbot </span>
</a>
